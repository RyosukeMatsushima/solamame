...
class FunctionsBase:
    ...
    def __init__(self, state_space, control_inputs_set, time_step, goal_function, obstace_function, edge_cost):
        self.element_count = state_space.element_count
        self.control_inputs_set = control_inputs_set
        self.time_step = time_step
        self.goal_function = goal_function

        self.obstacle_cost_map = np.array( [ obstace_function(element_number) for element_number in range(self.element_count) ] )
    ...
    def terminal_cost_map(self):
        return np.array( [ self.goal_function(element_number) for element_number in range(self.element_count) ] )
