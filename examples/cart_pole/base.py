...
class Base(BaseCommon):
    ...
    def __init__(self):
        ...
        self.model = CartPole((self.init_state["x"],
    ...
    def evaluate(self, inputs_space, cost_to_go_space):
        ...
        self.show_fig_with_path(["x", "x_dot"], {"x": 0, "x_dot": 0, "theta": 0, "theta_dot": 0}, state_space, result)
        self.show_fig_with_path(["theta", "theta_dot"], {"x": 0.0, "x_dot": 0, "theta": 0, "theta_dot": 0}, inputs_space, result)
